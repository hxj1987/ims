		...
		if(data[i].children != undefined && data[i].children.length > 0){
			...
			for(var j=0;j<data[i].children.length;j++){
				if(data[i].children[j].target == "_blank"){
					ulHtml += '<dd><a href="javascript:;" data-url="'+basePath+data[i].children[j].href+'" target="'+data[i].children[j].target+'">';
				}else{
			...
			if(data[i].target == "_blank"){
				ulHtml += '<a href="javascript:;" data-url="'+basePath+data[i].href+'" target="'+data[i].target+'">';
			}else{
