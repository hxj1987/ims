// var basePath = $("meta[name='ctx']").attr("content");
layui.config({
	...
	$.get(basePath+"/static/json/newsList.json",
		function(data){
			var waitNews = [];
	...
	//图片总数
	$.get(basePath+"/static/json/images.json",
		function(data){
	...
	//用户数
	$.get(basePath+"/static/json/usersList.json",
		function(data){
	...
	//新消息
	$.get(basePath+"/static/json/message.json",
		function(data){
